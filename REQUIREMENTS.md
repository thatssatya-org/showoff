...
- [x] Owner-approved curated entries are implemented: `Shaukeens`, `Chat with AI!`, Spotify `On Repeat`, and the `Aero India '23` Google Photos album. Music remains a static deep-link card; Aero India uses locally served, responsive approved images with a labelled carousel and direct album link.
